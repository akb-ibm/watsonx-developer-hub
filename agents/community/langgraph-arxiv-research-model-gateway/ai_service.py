def deployable_ai_service(context, url=None, model=None):
    import urllib
    from typing import Generator

    from langgraph_react_agent_model_gateway.agent import get_graph_closure
    ...
    graph = get_graph_closure(client, model)

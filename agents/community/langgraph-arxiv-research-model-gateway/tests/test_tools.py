...
class TestTools:
    def test_get_arxiv_contents(self, monkeypatch, url, mock_html, expected_output):
        ...
        monkeypatch.setattr("langgraph_react_agent_model_gateway.tools.AsyncHtmlLoader", mock_loader)
        monkeypatch.setattr("langgraph_react_agent_model_gateway.tools.MarkdownifyTransformer", mock_transformer)

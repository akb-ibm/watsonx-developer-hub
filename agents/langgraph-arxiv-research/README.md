...
- ### Step 1: Clone the repository
  ...
  git sparse-checkout add agents/langgraph-arxiv-research/
  ```
  ...
  > [!NOTE]
  > From now on it'll be considered that the working directory is `watsonx-developer-hub/agents/langgraph-arxiv-research/`
